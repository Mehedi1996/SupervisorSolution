...
import com.mehedihasan.supervisorsolution.adapters.SupervisorInitialAdapter;
        ...
        switch (view.getId()) {
            ...
            case R.id.tvSupervisorProfileLink:
                if (supervisor.getProfileLink() != null) {
                    Intent intent = new Intent(this, com.mehedihasan.supervisorsolution.activities.WebViewAndGroupListDetailsActivity.class);
